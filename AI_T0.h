//Wiezyczki kreca sie w kolko i strzelaja kiedy przeciwnik lub wiezyczka znajdzie sie na linii strzalu

void AI_T0(sf::Clock& stoper, int **D, int **CI, double **CD, int **TI, double **TD, int n, int nmax, int r)
{
