//Czolgi strzelaja kiedy przeciwnik lub wiezyczka znajdzie sie na linii strzalu
//Czolgi po napotkaniu przeszkody skrecaja w lewo, jezeli kat wiezy jest zgodny z kierunkiem ruchu nastepuje wystrzal

void AI_3(sf::Clock& stoper ,int **D, int **CI, double **CD, int **TI, int n, int nmax, int r)
{
